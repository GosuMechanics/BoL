...
local q = {
        [0] = {Range = 500, Speed = math.huge, Delay = 0.25, Width=55}, 
...
function OnLoad()
    ...
    --UPL:AddSpell(_Q, { speed = math.huge, delay = 0.25, range = 500, width = 55, collision = false, aoe = true, type = "linear" })
    --UPL:AddSpell(-2, { speed = 1500, delay = 0.4, range = 1000, width = 90, collision = false, aoe = true, type = "linear" })
    QSpell = _Spell({Slot = _Q, DamageName = "Q", Range = 500, Width = 55, Delay = 0.25, Speed = 1500, Collision = false, Aoe = true, Type = SPELL_TYPE.LINEAR}):AddDraw()
    QSpell3 = _Spell({Slot = _Q, DamageName = "Q3", Range = 1000, Width = 90, Delay = 0.4, Speed = 1500, Collision = false, Aoe = true, Type = SPELL_TYPE.LINEAR}):AddDraw()
...
function Menu()
    ...
    --Config:addParam("hc", "Prediction HitChance", SCRIPT_PARAM_SLICE, 2, 1, 3, 0)
